...
export const suites: Suite[] = [
  {
    ...
    rate: "$990",
    bookingUrl:
      "https://be.synxis.com/?chain=22402&hotel=78821&locale=en-GB&src=24C&filter=HOTEL&Room=SNI",
    heroImage: "/images/suites/Insp/1.jpg",
    highlights: [
    ...
    details: [
      {
        ...
        image: "/images/suites/Insp/2.jpg",
      },
      {
        label: "Bathroom",
        copy: "Luxurious bathroom features a semi-open shower with beautiful views and double-sinks.",
        image: "/images/suites/Insp/3.jpg",
      },
      {
        label: "Bedroom",
        copy: "Large windows and oriental design create a cozy and unique atmosphere.",
        image: "/images/suites/Insp/4.jpg",
      },
      {
        label: "View",
        copy: "Stunning bay views from the plunge pool and terrace.",
        image: "/images/suites/Insp/5.jpg",
      },
    ],
    gallery: [
      "/images/suites/Insp/1.jpg",
      "/images/suites/Insp/2.jpg",
      "/images/suites/Insp/3.jpg",
      "/images/suites/Insp/4.jpg",
      "/images/suites/Insp/5.jpg",
      "/images/suites/Insp/6.jpg",
      "/images/suites/Insp/7.jpg",
      "/images/suites/Insp/8.jpg",
      "/images/suites/Insp/9.jpg",
    ],
    amenities: [
  ...
  },
  {
    ...
    rate: "$890",
    bookingUrl:
      "https://be.synxis.com/?chain=22402&hotel=78821&locale=en-GB&src=24C&filter=HOTEL&Room=RMS",
    heroImage: "/images/suites/roma/1.jpg",
    highlights: [
    ...
    details: [
      {
        ...
        image: "/images/suites/roma/2.jpg",
      },
      {
        label: "Terrace",
        copy: "Two level terrace with plunge pool and cozy furnishings.",
        image: "/images/suites/roma/3.jpg",
      },
      {
        label: "Bedroom",
        copy: "Bright interior with unique Mexican character and wonderful bay views.",
        image: "/images/suites/roma/4.jpg",
      },
      {
        label: "View",
        copy: "Wonderful view to the heart of Zihuatanejo bay.",
        image: "/images/suites/roma/5.jpg",
      },
    ],
    gallery: [
      "/images/suites/roma/1.jpg",
      "/images/suites/roma/2.jpg",
      "/images/suites/roma/3.jpg",
      "/images/suites/roma/4.jpg",
      "/images/suites/roma/5.jpg",
      "/images/suites/roma/6.jpg",
    ],
    amenities: [
      "Housekeeping twice a day",
      "Luxury herbal toiletries",
  ...
  },
  {
    ...
    rate: "$790",
    bookingUrl:
      "https://be.synxis.com/?chain=22402&hotel=78821&locale=en-GB&src=24C&filter=HOTEL&Room=CRE",
    heroImage: "/images/suites/Crep/1.jpg",
    highlights: [
    ...
    details: [
      {
        ...
        image: "/images/suites/Crep/2.jpg",
      },
      {
        label: "Terrace",
        copy: "Two level terrace with plunge pool offering great ocean views.",
        image: "/images/suites/Crep/3.jpg",
      },
      {
        label: "Interior",
        copy: "Large ceilings and original furniture create a charming atmosphere.",
        image: "/images/suites/Crep/4.jpg",
      },
      {
        label: "View",
        copy: "Great views from the terrace plunge pool blend with beautiful surroundings.",
        image: "/images/suites/Crep/5.jpg",
      },
    ],
    gallery: [
      "/images/suites/Crep/1.jpg",
      "/images/suites/Crep/2.jpg",
      "/images/suites/Crep/3.jpg",
      "/images/suites/Crep/4.jpg",
      "/images/suites/Crep/5.jpg",
      "/images/suites/Crep/6.jpg",
    ],
    amenities: [
      "Housekeeping twice a day",
      "Luxury herbal toiletries",
  ...
  },
  {
    ...
    rate: "$690",
    bookingUrl:
      "https://be.synxis.com/?chain=22402&hotel=78821&locale=en-GB&src=24C&filter=HOTEL&Room=TAL",
    heroImage: "/images/suites/Talis/1.jpg",
    highlights: [
    ...
    details: [
      {
        ...
        image: "/images/suites/Talis/2.jpg",
      },
      {
        label: "Garden",
        copy: "Quiet garden setting with peaceful ambience.",
        image: "/images/suites/Talis/3.jpg",
      },
      {
        label: "Interior",
        copy: "Comfortable bedroom with great ocean views.",
        image: "/images/suites/Talis/4.jpg",
      },
      {
        label: "View",
        copy: "Great ocean views from the garden suite terrace.",
        image: "/images/suites/Talis/5.jpg",
      },
    ],
    gallery: [
      "/images/suites/Talis/1.jpg",
      "/images/suites/Talis/2.jpg",
      "/images/suites/Talis/3.jpg",
      "/images/suites/Talis/4.jpg",
      "/images/suites/Talis/5.jpg",
    ],
    amenities: [
      "Housekeeping twice a day",
      "Luxury herbal toiletries",
